...
function Mailer() {
  ...
  const handlesend = async () => {
    ...
    const response = await fetch("https://gyws-backend-ptg5.onrender.com/api/Mail", {
      method: "POST",
      body: formData,
    });
    ...
    <>
      ...
      <div className="isolate bg-white px-6 py-6 sm:py-6 lg:px-8">
        <div
          ...
          aria-hidden="true"
        >
          <div className="relative left-1/2 -z-10 aspect-[1155/678] w-[36.125rem] max-w-none -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-[#f26a36] to-[#f26a36] opacity-30 sm:left-[calc(50%-40rem)] sm:w-[72.1875rem] extra"></div>
        </div>
